...
public class MovieAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // public TextView textView, descView;
    ...
    public MovieAdapter(ArrayList<MovieModel> movieModels,MovieDB db, Context context,SwipeRefreshLayout swipeRefreshLayout){
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editTextValue.length() > 0 && editDescValue.length() > 0 && selectedImageUri != null) {
                    ...
                    db.updateMovie(mv.mId,editTextValue,editDescValue,inputData);
                    movieModels = db.getAllMovies();
